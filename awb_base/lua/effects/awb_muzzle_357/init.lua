function EFFECT:Init( data )
	...
	local emitter = ParticleEmitter( self.Origin ) // Creates the actual emitter
        ...
        for i=1, 6 do
            ...
            part:SetStartSize( math.random ( 0.05, 1 ) )
            part:SetEndSize( 0 )
            part:SetDieTime( 0.5 )
	...
	local emitter = ParticleEmitter( self.Origin ) // Creates the actual emitter
        ...
        for i=1, 8 do
            ...
            part:SetStartSize( math.random ( 0.1, 0.5 ) )
            part:SetEndSize( 0 )
            part:SetDieTime( 1 )
            part:SetColor( 255, math.random ( 100, 255 ), math.random ( 0, 50 ), 50 )
            part:SetVelocity( Vector( math.random( -16, -16 ), math.random( -16, 16 ), math.random( 1, 64 ) ) )
            part:SetGravity( Vector( 0, 0, -256 )  )
            part:SetRoll( math.random( 0, 360 )  )
	...
	local emitter = ParticleEmitter( self.Origin) // Creates the actual emitter
        ...
        part:SetStartSize( math.random ( 12, 24 ) )
