function EFFECT:Init( data )
	...
	local emitter = ParticleEmitter( self.Origin ) // Creates the actual emitter
        ...
        for i=1, 5 do
            ...
            part:SetStartSize( math.random ( 0.05, 0.1 ) )
            part:SetEndSize( 0 )
            part:SetDieTime( 0.5 )
	...
	local emitter = ParticleEmitter( self.Origin ) // Creates the actual emitter
        ...
        for i=1, 25 do
            ...
            part:SetStartSize( math.random ( 0.5, 2 ) )
            part:SetEndSize( 0 )
            part:SetDieTime( 0.25 )
            part:SetColor( 255, 255, math.random ( 200, 255 ), math.random ( 100, 255 ), math.random ( 25, 100 ) )
            part:SetVelocity( Vector( math.random( -16, -16 ), math.random( -16, 16 ), math.random( 1, 64 ) ) )
            part:SetGravity( Vector( 0, 0, -256 )  )
            part:SetRoll( math.random( 0, 360 )  )
